            ...
            <div class="col-md-10 col-lg-8">
                <div>
                    <div class="header-container d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('events.create') }}" class="arrow-button text-black fs-4 text-decoration-none d-flex align-items-center">
                            <i class="bi bi-plus-lg me-2 mt-1"></i>
                            <h5 class="mt-1 fw-bold mt-2">Create Event</h5>
                        </a>
                    </div>
                ...
                @include('layouts.contents.show-all-events')
            </div>
        </div>
