...
<body class="font-sans antialiased bg-white">
    <div
        ...
        <div class="flex items-center justify-center w-full max-w-2xl px-6 lg:max-w-7xl">
            <header class="flex justify-center w-full py-10">
                <a href="/" class="flex items-center no-underline text-black">
                    <i class="bi bi-app-indicator text-4xl"></i>
                    <h5 class="text-4xl font-bold ml-3">Edv</h5>
                </a>
            </header>
        </div>
        ...
        <footer class="py-16 text-center text-sm text-black">
            College of Computer Studies x UIC
        </footer>
    </div>
</body>
