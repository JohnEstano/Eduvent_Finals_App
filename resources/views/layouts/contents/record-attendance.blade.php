        ...
        <div class="col-md-10 col-lg-8">
            <div>
                ...
                <div class="header-container">
                    <a href="{{ route('users') }}" class="arrow-button text-black fs-4 me-2">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('users') }}"
                                class="text-decoration-none text-warning">Users</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add User</li>
                    </ol>
                </nav>
            </div>

            @include('layouts.contents.record-attendance-form')
        </div>
    </div>
</div>
